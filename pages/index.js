...
export default function Home() {
  ...
  return (
    <div className="app">
      <Header loading={loading} refresh={null}/>
      {/* {!hideNotification &&
      ...
      <div className="app-container">
        ...
        <p>Due to issues of support from the APIs from which we pull new sources and media ratings, this app is temporarily unavailable.  We are working to find alternative APIs in order to continue providing this service.</p>
      </div>
      {!loading &&
        <Footer/>
      }
